				...
				<div class="panel-body">					
					<div class="table-container">
						<form method="POST" action="{{ route('Usuarios.update',$usuario->id) }}"  role="form">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="email" name="correo" id="correo" class="form-control input-sm" value="{{$usuario->correo}}">
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="sexo" id="sexo" class="form-control input-sm" value="{{$usuario->sexo}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6">
